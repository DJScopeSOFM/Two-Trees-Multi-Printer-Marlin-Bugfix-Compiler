 ...
 */
    ...
    #endif
  #elif ENABLED(BABYSTEP_DISPLAY_TOTAL) && ANY(TFT_320x240, TFT_320x240_SPI, TFT_480x320, TFT_480x320_SPI, TFT_320x272)
    #error "New Color UI (TFT_320x240, TFT_320x240_SPI, TFT_480x320, TFT_480x320_SPI, TFT_320x272) does not support BABYSTEP_DISPLAY_TOTAL yet."
  #endif
#endif
